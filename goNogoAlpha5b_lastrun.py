...
expName = 'goNogoAlpha5b'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\goNogoAlpha5b\\goNogoAlpha5b_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if trialResp.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > trialResp.tStartRefresh + 0.75-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if trialText.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > trialText.tStartRefresh + 0.75-frameTolerance:
                    # keep track of stop time/frame for later
